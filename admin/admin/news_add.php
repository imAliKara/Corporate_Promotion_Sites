...
<body>
    ...
    <div class="col-10">
        ...
        <form action="news_control.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="exampleInputTitle" class="form-label">Haber Resim</label>
                <input type="file" name="news_photo" class="form-control">
            </div>
            <div class="mb-3">
                <label for="exampleInputOzet" class="form-label"> Haber Özet</label>
                <textarea name="news_ozet" class="form-control" rows="5"></textarea>
            </div>
            <div class="mb-3">
                <label for="exampleInputDetail" class="form-label">Haber Detay</label>
                <textarea id="rich" name="news_detail" class="form-control"></textarea>
            </div>
