        ...
        <form action="content_control.php" method="post">
            ...
            <div class="mb-3">
                ...
                <select name="content_place" class="form-control">
                    ...
                    <?php
                    $result = $con->query("SELECT * FROM tbl_content WHERE content_place=0");
                    if ($result->num_rows > 0) {
                        while ($data = $result->fetch_assoc()) {
                            ?>
                            <option value="<?=$data["content_id"]?>"><?=$data["content_link"]?></option>
                        <?php }
                    } ?>
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea id="rich" name="content_detail" class="form-control"></textarea>
            </div>
